...
public class CurrencyConversionService : ICurrencyConversionService
{
    ...
    public CurrencyConversionService(MobileDbContext context)
    {
        _context = context;
    }
    ...
    {
        // Offline-first: Use most recent rate available in local database
        ...
        if (rate == null)
            throw new NotFoundException($"Exchange rate not found from currency {fromCurrencyId} to {toCurrencyId}. Please ensure exchange rates are pre-seeded.");
